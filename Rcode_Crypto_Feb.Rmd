...
```{r}
rownames(R) <- dataSet$datecolumn[-c(1:2054)]
R<-as.xts(R)
...
prices<-tail(data, 672+length(mufree))
...
for(i in 1:length(mufree)){
  R.use<-as.data.frame(R[i:(672+i-1), ])
